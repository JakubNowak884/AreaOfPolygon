...
public class Triangle {
    ...
    /**
     * Class constructor forming a equilateral triangle of height 2 with the
     * bottom left corner at the coordinate system origin.
     */
    public Triangle() {
        a = new Point(0, 0);
        b = new Point(1, 2);
    ...
    /**
     * Class constructor forming a triangle from three given points in a 2d
     * space.
     *
     * @param a first point
